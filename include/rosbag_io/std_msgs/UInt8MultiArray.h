...
#include <rosbag_io/ros/message_operations.h>

#include <rosbag_io/std_msgs/MultiArrayLayout.h>
...
{
rosbag_io::ros::message_operations::Printer< ::std_msgs::UInt8MultiArray_<ContainerAllocator> >::stream(s, "", v);
return s;
}
